...
type NepalScreenNavigationProp = StackNavigationProp<RootStackParamList>;

const Nepal = ({ navigation }: { navigation: NepalScreenNavigationProp }) => {
    ...
    const places = [
        {
            ...
            rating: 5.0,
            duration: '12-14 Days',
            description: 'Legendary trekking destination offering breathtaking views of the world\'s highest peak',
        },
        {
            ...
            rating: 4.8,
            duration: '3 Hours',
            description: 'Sacred Hindu temple complex on the banks of the Bagmati River in Kathmandu',
        },
        {
            ...
            rating: 4.9,
            duration: 'Full Day',
            description: 'Beautiful freshwater lake with reflection of Mount Machhapuchhre on its surface',
        },
        {
            ...
            rating: 4.7,
            duration: '2-3 Days',
            description: 'First national park in Nepal, home to one-horned rhinos and Bengal tigers',
        },
        {
            ...
            rating: 4.9,
            duration: '2 Hours',
            description: 'One of the largest spherical stupas in the world and a major pilgrimage site',
        }
    ];
            ...
            >
                ...
                <Animated.View style={[styles.heroContainer, { height: headerHeight }]}>
                    ...
                    >
                        ...
                        <View style={styles.heroInfo}>
                            <Text style={styles.heroTitle}>Nepal</Text>
                            <View style={styles.statsBar}>
                                ...
                                <View style={styles.statItem}>
                                    ...
                                    <Text style={styles.statText}>10-15 Days</Text>
                                </View>
                                <View style={styles.statSeparator} />
                                <View style={styles.statItem}>
                                    <MaterialIcons name="payments" size={18} color={COLORS.white} />
                                    <Text style={styles.statText}>Spiritual</Text>
                                </View>
                                <View style={styles.statSeparator} />
                ...
                <View style={styles.content}>
                    <View style={styles.cardContainer}>
                        <Text style={styles.sectionTitle}>Roof of the World</Text>
                        <Text style={styles.aboutText}>
                            Nepal is a landlocked country in South Asia, located mainly in the Himalayas. It is home to eight of the world's ten highest mountains, including Mount Everest.
                        </Text>
                        
                        <View style={styles.highlightGrid}>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="filter_hdr" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Trekking</Text>
                            </View>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="temple_buddhist" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Temples</Text>
                            </View>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="explore" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Adventure</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.discoverySection}>
                        <Text style={styles.sectionTitle}>Himalayan Peaks</Text>
                        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.discoveryScroll}>
                            {places.map((place, index) => (
                                <TouchableOpacity key={index} style={styles.discoveryCard} onPress={() => navigation.navigate('Booking', { destinationName: 'Nepal', price: '₹12,499' })}>
                    ...
                    <TouchableOpacity style={[styles.bookButton, { marginTop: SPACING.xl }]} onPress={() => navigation.navigate('Booking', { destinationName: 'Nepal', price: '₹12,499' })}>
                        <LinearGradient
