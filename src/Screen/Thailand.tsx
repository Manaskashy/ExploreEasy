...
type ThailandScreenNavigationProp = StackNavigationProp<RootStackParamList>;

const Thailand = ({ navigation }: { navigation: ThailandScreenNavigationProp }) => {
    ...
    const places = [
        {
            ...
            rating: 4.9,
            duration: '3 Hours',
            description: 'Complex of buildings at the heart of Bangkok, which has been the official residence of the Kings of Siam',
        },
        {
            ...
            rating: 4.8,
            duration: '2-3 Days',
            description: 'Island group in Thailand between the large island of Phuket and the Straits of Malacca coast of Thailand',
        },
        {
            name: 'Wat Arun',
            ...
            rating: 4.8,
            duration: '2 Hours',
            description: 'Buddhist temple in Bangkok Riverside, Yai district of Bangkok, Thailand, on the Thonburi west bank of the Chao Phraya River',
        },
        {
            name: 'Railay Beach',
            image: require('../assets/image2.jpg'),
            rating: 4.9,
            duration: '2 Days',
            description: 'Small peninsula between the city of Krabi and Ao Nang in Thailand, accessible only by boat',
        },
        {
            name: 'Doi Suthep',
            image: require('../assets/Lakshadweep.webp'),
            rating: 4.7,
            duration: 'Half Day',
            description: 'Regarded as one of the holiest places in Thailand, this mountain offers spectacular views of Chiang Mai',
        }
    ];
            ...
            >
                ...
                <View style={styles.content}>
                    <View style={styles.cardContainer}>
                        <Text style={styles.sectionTitle}>Land of Smiles</Text>
                        <Text style={styles.aboutText}>
                            Thailand is known for tropical beaches, opulent royal palaces, ancient ruins and ornate temples. It offers a unique mix of modern city life and traditional culture.
                        </Text>
                        ...
                        <View style={styles.highlightGrid}>
                            ...
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="restaurant_menu" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Street Food</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.discoverySection}>
                        ...
                        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.discoveryScroll}>
                            {places.map((place, index) => (
                                <TouchableOpacity key={index} style={styles.discoveryCard} onPress={() => navigation.navigate('Booking', { destinationName: 'Thailand', price: '₹18,999' })}>
                    ...
                    <TouchableOpacity style={[styles.bookButton, { marginTop: SPACING.xl }]} onPress={() => navigation.navigate('Booking', { destinationName: 'Thailand', price: '₹18,999' })}>
                        <LinearGradient
