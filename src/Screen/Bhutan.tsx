...
type BhutanScreenNavigationProp = StackNavigationProp<RootStackParamList>;

const Bhutan = ({ navigation }: { navigation: BhutanScreenNavigationProp }) => {
    ...
    const places = [
        {
            ...
            rating: 5.0,
            duration: 'Full Day',
            description: 'Iconic Tiger’s Nest monastery clinging to a cliffside',
        },
        {
            name: 'Punakha Dzong',
            ...
            rating: 4.9,
            duration: '3 Hours',
            description: 'The most beautiful fortress in Bhutan at the confluence of two rivers',
        },
        {
            name: 'Thimphu Valley',
            ...
            rating: 4.8,
            duration: '2 Days',
            description: 'The charming capital city blending tradition with modernity',
        },
        {
            name: 'Chele La Pass',
            ...
            rating: 4.7,
            duration: 'Half Day',
            description: 'Highest motorable point in Bhutan with stunning Himalayan views',
        }
    ];
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <Animated.View style={[styles.heroContainer, { height: headerHeight }]}>
                    <Image source={require('../assets/bhutan.jpg')} style={styles.heroImage} />
                    <LinearGradient
                    ...
                    >
                        ...
                        <View style={styles.heroInfo}>
                            <Text style={styles.heroTitle}>Bhutan</Text>
                            <View style={styles.statsBar}>
                                ...
                                <View style={styles.statItem}>
                                    ...
                                    <Text style={styles.statText}>Unique</Text>
                                </View>
                                <View style={styles.statSeparator} />
                ...
                <View style={styles.content}>
                    <View style={styles.cardContainer}>
                        <Text style={styles.sectionTitle}>The Last Shangri-La</Text>
                        <Text style={styles.aboutText}>
                            Bhutan is a landlocked country in the Eastern Himalayas, known for its monasteries, fortresses and dramatic landscapes. It is famous for its philosophy of Gross National Happiness.
                        </Text>
                        
                        <View style={styles.highlightGrid}>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="landscape" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Himalayas</Text>
                            </View>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="church" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Spirituality</Text>
                            </View>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="eco" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Happiness</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.discoverySection}>
                        <Text style={styles.sectionTitle}>Spiritual Landmarks</Text>
                        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.discoveryScroll}>
                            {places.map((place, index) => (
                                <TouchableOpacity key={index} style={styles.discoveryCard} onPress={() => navigation.navigate('Booking', { destinationName: 'Bhutan', price: '₹28,999' })}>
                    ...
                    {/* Detailed List */}
                    <Text style={styles.sectionTitle}>Uncover Bhutan</Text>
                    {places.map((place, index) => (
                    ...
                    <TouchableOpacity style={[styles.bookButton, { marginTop: SPACING.xl }]} onPress={() => navigation.navigate('Booking', { destinationName: 'Bhutan', price: '₹28,999' })}>
                        <LinearGradient
