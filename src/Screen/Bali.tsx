...
type BaliScreenNavigationProp = StackNavigationProp<RootStackParamList>;

const Bali = ({ navigation }: { navigation: BaliScreenNavigationProp }) => {
    ...
    const places = [
        ...
        },
        {
            ...
            rating: 4.7,
            duration: '2-3 Hours',
            description: 'Sacred forest sanctuary home to hundreds of Balinese long-tailed monkeys',
        },
        {
            ...
            rating: 4.8,
            duration: '2 Hours',
            description: 'Iconic stepped rice fields offering breathtaking valley views',
        },
        {
            name: 'Mount Batur',
            image: require('../assets/image2.jpg'),
            rating: 4.8,
            duration: 'Full Day',
            description: 'Active volcano perfect for sunrise trekking and panoramic lake views',
        },
        {
            name: 'Tanah Lot',
            image: require('../assets/Lakshadweep.webp'),
            rating: 4.9,
            duration: 'Half Day',
            description: 'Famous rock formation home to an ancient Hindu pilgrimage temple',
        }
    ];
            ...
            >
                ...
                <Animated.View style={[styles.heroContainer, { height: headerHeight }]}>
                    ...
                    >
                        ...
                        <View style={styles.heroInfo}>
                            <Text style={styles.heroTitle}>Bali</Text>
                            <View style={styles.statsBar}>
                                ...
                                <View style={styles.statItem}>
                                    ...
                                    <Text style={styles.statText}>5-8 Days</Text>
                                </View>
                                <View style={styles.statSeparator} />
                                <View style={styles.statItem}>
                                    <MaterialIcons name="payments" size={18} color={COLORS.white} />
                                    <Text style={styles.statText}>Lush</Text>
                                </View>
                                <View style={styles.statSeparator} />
                ...
                <View style={styles.content}>
                    <View style={styles.cardContainer}>
                        <Text style={styles.sectionTitle}>Island of the Gods</Text>
                        <Text style={styles.aboutText}>
                            Bali is a province of Indonesia and the westernmost of the Lesser Sunda Islands. It is Indonesia's main tourist destination, known for its spiritual culture and stunning landscapes.
                        </Text>
                        
                        <View style={styles.highlightGrid}>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="self_improvement" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Spiritual</Text>
                            </View>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="surfing" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Surfing</Text>
                            </View>
                            <View style={styles.highlightBox}>
                    ...
                    <View style={styles.discoverySection}>
                        <Text style={styles.sectionTitle}>Balinese Wonders</Text>
                        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.discoveryScroll}>
                            {places.map((place, index) => (
                                <TouchableOpacity key={index} style={styles.discoveryCard} onPress={() => navigation.navigate('Booking', { destinationName: 'Bali', price: '₹35,999' })}>
                    ...
                    <TouchableOpacity style={[styles.bookButton, { marginTop: SPACING.xl }]} onPress={() => navigation.navigate('Booking', { destinationName: 'Bali', price: '₹35,999' })}>
                        <LinearGradient
