...
type MaldivesScreenNavigationProp = StackNavigationProp<RootStackParamList>;

const Maldives = ({ navigation }: { navigation: MaldivesScreenNavigationProp }) => {
            ...
            >
                ...
                <Animated.View style={[styles.heroContainer, { height: headerHeight }]}>
                    ...
                    >
                        ...
                        <View style={styles.heroInfo}>
                            <Text style={styles.heroTitle}>Maldives</Text>
                ...
                <View style={styles.content}>
                    <View style={styles.cardContainer}>
                        <Text style={styles.sectionTitle}>The Tropical Paradise</Text>
                        ...
                        <View style={styles.highlightGrid}>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="scuba_diving" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Diving</Text>
                            </View>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="nightlife" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Resorts</Text>
                            </View>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="water" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Lagoon</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.discoverySection}>
                        <Text style={styles.sectionTitle}>Island Escapes</Text>
                        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.discoveryScroll}>
                            {places.map((place, index) => (
                                <TouchableOpacity key={index} style={styles.discoveryCard} onPress={() => navigation.navigate('Booking', { destinationName: 'Maldives', price: '₹85,999' })}>
                    ...
                    <TouchableOpacity style={[styles.bookButton, { marginTop: SPACING.xl }]} onPress={() => navigation.navigate('Booking', { destinationName: 'Maldives', price: '₹85,999' })}>
                        <LinearGradient
