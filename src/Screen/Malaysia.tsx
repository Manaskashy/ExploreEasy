...
type MalaysiaScreenNavigationProp = StackNavigationProp<RootStackParamList>;

const Malaysia = ({ navigation }: { navigation: MalaysiaScreenNavigationProp }) => {
    ...
    const places = [
        {
            ...
            rating: 4.9,
            duration: '2 Hours',
            description: 'Iconic twin skyscrapers in Kuala Lumpur, once the tallest buildings in the world',
        },
        {
            name: 'Batu Caves',
            ...
            rating: 4.7,
            duration: 'Half Day',
            description: 'Limestone hill with a series of caves and cave temples, featuring a giant golden statue',
        },
        {
            ...
            rating: 4.8,
            duration: '3-4 Days',
            description: 'Archipelago of 99 islands known for its beaches, rainforests, and cable car rides',
        },
        {
            ...
            rating: 4.6,
            duration: '2 Days',
            description: 'Hill station famous for its tea plantations, strawberry farms, and cool climate',
        },
        {
            name: 'Malacca City',
            image: require('../assets/Lakshadweep.webp'),
            rating: 4.7,
            duration: '2 Days',
            description: 'Historic city with a rich colonial past, vibrant street art, and delicious Nyonya cuisine',
        }
    ];
            ...
            >
                ...
                <Animated.View style={[styles.heroContainer, { height: headerHeight }]}>
                    ...
                    >
                        ...
                        <View style={styles.heroInfo}>
                            <Text style={styles.heroTitle}>Malaysia</Text>
                            <View style={styles.statsBar}>
                                ...
                                <View style={styles.statItem}>
                                    ...
                                    <Text style={styles.statText}>5-9 Days</Text>
                                </View>
                                <View style={styles.statSeparator} />
                                <View style={styles.statItem}>
                                    <MaterialIcons name="payments" size={18} color={COLORS.white} />
                                    <Text style={styles.statText}>Diverse</Text>
                                </View>
                                <View style={styles.statSeparator} />
                ...
                <View style={styles.content}>
                    <View style={styles.cardContainer}>
                        <Text style={styles.sectionTitle}>Truly Asia</Text>
                        <Text style={styles.aboutText}>
                            Malaysia is a Southeast Asian country occupying parts of the Malay Peninsula and the island of Borneo. It's known for its mix of cultural influences and natural beauty.
                        </Text>
                        ...
                        <View style={styles.highlightGrid}>
                            ...
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="park" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Rainforest</Text>
                            </View>
                            <View style={styles.highlightBox}>
                                <MaterialIcons name="public" size={24} color={COLORS.primary} />
                                <Text style={styles.highlightText}>Culture</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.discoverySection}>
                        ...
                        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.discoveryScroll}>
                            {places.map((place, index) => (
                                <TouchableOpacity key={index} style={styles.discoveryCard} onPress={() => navigation.navigate('Booking', { destinationName: 'Malaysia', price: '₹21,999' })}>
                    ...
                    <TouchableOpacity style={[styles.bookButton, { marginTop: SPACING.xl }]} onPress={() => navigation.navigate('Booking', { destinationName: 'Malaysia', price: '₹21,999' })}>
                        <LinearGradient
